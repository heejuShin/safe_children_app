...
import {Text, View, Button, StyleSheet, Image, Switch, Alert, TouchableOpacity, Platform} from 'react-native';
...
import AsyncStorage from '@react-native-async-storage/async-storage'; //내장저장

const LOCATION_TASK_NAME = 'background-location-task';

const requestPermissions = async () => {
  console.log("백그라운드 위치 정보 받아오기 - start");
  ...
  console.log("백그라운드 위치 정보 받아오기 - end");
};
...
TaskManager.defineTask(LOCATION_TASK_NAME, ({ data, error }) => {
  ...
  if (data) {
    ...
    console.log("success ->"  + locations[0].coords.latitude + " + " + locations[0].coords.longitude);
    ...
    : (
        <View style={styles.background}>
          ...
          : <View style={{ flexGlow: 1, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <TouchableOpacity style={styles2.container} onPress={requestPermissions}>
